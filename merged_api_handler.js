...
exports.handler = async (event, context, callback) => {
                ...
                if (event.body) {
                    ...
                    if (requestBody.tags && requestBody.url && requestBody.type) {
                        ...
                        try {
                            ...
                            body: JSON.stringify({ message: 'Error subscribing email to SNS' })
                        }
                    }
                        ...
                        let filterExpression = tags.map((_, i) => `contains(tags, :tag${i})`).join(" AND ");
                        ...
                        try {
                            ...
                            for (let item of response.Items) {
                                ...
                                for (let tag of tags) {
                                    ...
                                    const actualCount = item.tags.filter(t => t === tagName).length;
    ...
    return {
        statusCode, body, headers, headers: {
